                ...
                {cars.map((car) => (
                    <div key={car.id} className="car-card">
                        ...
                        <div className="car-card-actions">
                            <Link to={`/cars/${car.id}`} className="btn btn-secondary">View</Link>
                            <Link to={`/cars/${car.id}/edit`} className="btn btn-primary">Edit</Link>
                            <button onClick={() => handleDelete(car.id)} className="btn btn-danger">Delete</button>
                        </div>
                    </div>
                ))}
            </div>
